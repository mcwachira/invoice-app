...
const userSchema = new Schema(
  {
    ...
    username: {
      ...
      validate: {
        ...
        message:
          "username must be alphanumeric without any special characters. , hyphens and underscores are allowed ",
      },
    },
    firstName: {
      type: String,
      ...
      validate: [
        ...
        "firstName can only have alpha numeric values . No special characters allowed",
      ],
    },
    lastName: {
      type: String,
      ...
      validate: [
        validator.isAlphanumeric,
        "LastName can only have alpha numeric values . No special characters allowed",
      ],
    },
    password: {
      type: String,
