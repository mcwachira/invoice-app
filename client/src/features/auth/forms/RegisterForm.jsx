...
const RegisterForm = () => {
  ...
  const handleShowHideConfirmPassword = (event) => {
  ...
  const changePassword = (value) => {
    ...
    setLevel(strengthIndicator(temp));
  };
  ...
  //data -content from  the server
  //isSuccess -shows if fetching of content is successful and there is cached data
  //isLoading -  boolean indicating if function  is making first request from server
    ...
    <>
      <Formik
        ...
        onSubmit={async (values, { setStatus, setSubmitting }) => {
          try {
            //unwarap rtk method handles  potential errors in try catch block
